RSpec.describe Nova::API::Resource::ApportionmentValue do
  ...
  describe '.create' do
    ...
    it 'issues a post to the apportionment create endpoint' do
      expect(HTTParty).to receive(:post).with("#{described_class.base_url}#{described_class.endpoint(apportionment_id)}", body: parameters, headers: authorization_header, format: :json).and_return(response)
  ...
  describe '.update' do
    ...
    context 'when the id is set' do
      ...
      it 'issues a patch to the apportionment update endpoint' do
        expect(HTTParty).to receive(:patch).with("#{described_class.base_url}#{described_class.endpoint(apportionment_id)}/#{id}", body: parameters, headers: authorization_header, format: :json).and_return(response)
  ...
  describe '.destroy' do
    ...
    context 'when the id is set' do
      ...
      it 'issues a delete to the apportionment delete endpoint' do
        expect(HTTParty).to receive(:delete).with("#{described_class.base_url}#{described_class.endpoint(apportionment_id)}/#{id}", headers: authorization_header, format: :json).and_return(response)
  ...
  describe '.reactivate' do
    ...
    context 'when the id is set' do
      ...
      it 'issues a patch to the apportionment reactivate endpoint' do
        expect(HTTParty).to receive(:patch).with("#{described_class.base_url}#{described_class.endpoint(apportionment_id)}/#{id}/reactivate", headers: authorization_header, format: :json).and_return(response)
